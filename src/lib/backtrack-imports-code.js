...
export class Graph{
    ...
    findAllPaths = function (filePath, relevantChunks) {
        ...
        this.findParents(node, arr, paths, relevantChunks, flag);
        return paths;
    }
    
    findParents = function (node, arr, paths, relevantChunks, flag) {
        ...
        node.parents.forEach(parent => {
            ...
            if (flag===true && newFlag===false) {
                ...
                this.findParents(parent, arr, paths, relevantChunks, flag);
                arr.pop();
            }
        });
    }
